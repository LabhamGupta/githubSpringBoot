...
The purse contained many gold coins and a note from the King explaining that the gold was for the person who removed the boulder from the roadway.',
        '2022-06-14', 'The Obstacles In Our Path', 2);
...
it’s never too late to change what the future looks like.','2022-06-14', 'Life', 1);
...
Despite the kind heart of the man, he didn’t understand that the restricting cocoon and the struggle needed by the butterfly to get itself through the small opening; were God’s way of forcing fluid from the body of the butterfly into its wings. To prepare itself for flying once it was out of the cocoon.',
        '2022-06-14', 'Struggles in life Develop Our Strengths', 2);
